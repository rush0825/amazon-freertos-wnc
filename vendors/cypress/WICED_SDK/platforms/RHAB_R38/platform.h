...
typedef enum
{
    ...
    WICED_GPIO_26,
    WICED_GPIO_27,
    WICED_GPIO_28, // sharn add
    WICED_GPIO_29, // sharn add
    WICED_GPIO_30, // sharn add
    WICED_GPIO_31, // David add
    WICED_GPIO_32, // David add
    WICED_GPIO_33, // David add
    WICED_GPIO_34, // David add
...
#define WICED_LED3         ( WICED_GPIO_32 )
#define WICED_LED4         ( WICED_GPIO_11 )
#define WICED_BUTTON1      ( WICED_GPIO_27 )
#define WICED_BUTTON2      ( WICED_GPIO_34 )
#define WICED_BUTTON3      ( WICED_GPIO_24 )
#define WICED_BUTTON4      ( WICED_GPIO_26 )
